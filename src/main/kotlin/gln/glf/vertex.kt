...
object glf {
    ...
    object pos2 : VertexLayout {
        ...
        override var attributes = arrayOf(
                VertexAttribute(semantic.attr.POSITION, Vec2.length, VertexAttribType(GL_FLOAT), false, stride, 0))
    }
    ...
    object pos3_col4 : VertexLayout {
        ...
        override var attributes = arrayOf(
                VertexAttribute(semantic.attr.POSITION, Vec3.length, VertexAttribType(GL_FLOAT), false, stride, 0),
                VertexAttribute(semantic.attr.COLOR, Vec4.length, VertexAttribType(GL_FLOAT), false, stride, Vec3.size.L))
    }
    ...
    object pos3_col4b : VertexLayout {
        ...
        override var attributes = arrayOf(
                VertexAttribute(semantic.attr.POSITION, Vec3.length, VertexAttribType(GL_FLOAT), false, stride, 0),
                VertexAttribute(semantic.attr.COLOR, Vec4b.length, VertexAttribType(GL_UNSIGNED_BYTE), false, stride, Vec3.size.L))
    }
    ...
    object pos4_col4 : VertexLayout {
        ...
        override var attributes = arrayOf(
                VertexAttribute(semantic.attr.POSITION, Vec4.length, VertexAttribType(GL_FLOAT), false, stride, 0),
                VertexAttribute(semantic.attr.COLOR, Vec4.length, VertexAttribType(GL_FLOAT), false, stride, Vec4.size.L))
    }
    ...
    object pos4_col4_uv2 : VertexLayout {
        ...
        override var attributes = arrayOf(
                VertexAttribute(semantic.attr.POSITION, Vec4.length, VertexAttribType(GL_FLOAT), false, stride, 0),
                VertexAttribute(semantic.attr.COLOR, Vec4.length, VertexAttribType(GL_FLOAT), false, stride, Vec4.size.L),
                VertexAttribute(semantic.attr.TEX_COORD, Vec2.length, VertexAttribType(GL_FLOAT), false, stride, Vec4.size.L * 2))
    }
    ...
    object pos2_tc2 : VertexLayout {
        ...
        override var attributes = arrayOf(
                VertexAttribute(semantic.attr.POSITION, Vec2.length, VertexAttribType(GL_FLOAT), false, stride, 0),
                VertexAttribute(semantic.attr.TEX_COORD, Vec2.length, VertexAttribType(GL_FLOAT), false, stride, Vec2.size.L))
    }
    ...
    object pos2_tc2_col4b : VertexLayout {
        ...
        override var attributes = arrayOf(
                VertexAttribute(semantic.attr.POSITION, Vec2.length, VertexAttribType(GL_FLOAT), false, stride, 0),
                VertexAttribute(semantic.attr.TEX_COORD, Vec2.length, VertexAttribType(GL_FLOAT), false, stride, Vec2.size.L),
                VertexAttribute(semantic.attr.COLOR, Vec4b.length, VertexAttribType(GL_FLOAT), false, stride, Vec2.size.L * 2))
    }

    object pos2us_tc2us : VertexLayout {
        val stride = Vec2us.size * 2
        override var attributes = arrayOf(
                VertexAttribute(semantic.attr.POSITION, Vec2us.length, VertexAttribType(GL_UNSIGNED_SHORT), false, stride, 0),
                VertexAttribute(semantic.attr.TEX_COORD, Vec2us.length, VertexAttribType(GL_UNSIGNED_SHORT), false, stride, Vec2us.size.L))
    }
    ...
    object pos3_tc2 : VertexLayout {
        ...
        override var attributes = arrayOf(
                VertexAttribute(semantic.attr.POSITION, Vec3.length, VertexAttribType(GL_FLOAT), false, stride, 0),
                VertexAttribute(semantic.attr.TEX_COORD, Vec2.length, VertexAttribType(GL_FLOAT), false, stride, Vec3.size.L))
    }
    ...
    object pos3_col4ub : VertexLayout {
        ...
        override var attributes = arrayOf(
                VertexAttribute(semantic.attr.POSITION, Vec3.length, VertexAttribType(GL_FLOAT), false, stride, 0),
                VertexAttribute(semantic.attr.COLOR, Vec4ub.length, VertexAttribType(GL_UNSIGNED_BYTE), false, stride, Vec3.size.L))
    }
    ...
    object pos2_tc3 : VertexLayout {
        ...
        override var attributes = arrayOf(
                VertexAttribute(semantic.attr.POSITION, Vec2.length, VertexAttribType(GL_FLOAT), false, stride, 0),
                VertexAttribute(semantic.attr.TEX_COORD, Vec3.length, VertexAttribType(GL_FLOAT), false, stride, Vec2.size.L))
    }
    ...
    object pos3_tc3 : VertexLayout {
        ...
        override var attributes = arrayOf(
                VertexAttribute(semantic.attr.POSITION, Vec3.length, VertexAttribType(GL_FLOAT), false, stride, 0),
                VertexAttribute(semantic.attr.TEX_COORD, Vec3.length, VertexAttribType(GL_FLOAT), false, stride, Vec3.size.L))
    }
    ...
    object pos3_nor3 : VertexLayout {
        ...
        override var attributes = arrayOf(
                VertexAttribute(semantic.attr.POSITION, Vec3.length, VertexAttribType(GL_FLOAT), false, stride, 0),
                VertexAttribute(semantic.attr.NORMAL, Vec3.length, VertexAttribType(GL_FLOAT), false, stride, Vec3.size.L))
    }
    ...
    object pos3_nor3_tc2 : VertexLayout {
        ...
        override var attributes = arrayOf(
                VertexAttribute(semantic.attr.POSITION, Vec3.length, VertexAttribType(GL_FLOAT), false, stride, 0),
                VertexAttribute(semantic.attr.NORMAL, Vec3.length, VertexAttribType(GL_FLOAT), false, stride, Vec3.size.L),
                VertexAttribute(semantic.attr.TEX_COORD, Vec2.length, VertexAttribType(GL_FLOAT), false, stride, Vec3.size.L * 2))
    }
    ...
    object pos3_nor3_col4 : VertexLayout {
        ...
        override var attributes = arrayOf(
                VertexAttribute(semantic.attr.POSITION, Vec3.length, VertexAttribType(GL_FLOAT), false, stride, 0),
                VertexAttribute(semantic.attr.NORMAL, Vec3.length, VertexAttribType(GL_FLOAT), false, stride, Vec3.size.L),
                VertexAttribute(semantic.attr.COLOR, Vec4.length, VertexAttribType(GL_FLOAT), false, stride, Vec3.size.L * 2))
    }
