...
interface gl13i {
     ...
     */
    fun compressedTexImage3D(target: TextureTarget, level: Int, internalFormat: InternalFormat, size: Vec3i, imageSize: Int, data: Ptr = NULL) {
        GL13C.nglCompressedTexImage3D(target.i, level, internalFormat.i, size.x, size.y, size.z, 0, imageSize, data)
    }
     ...
     * @see <a target="_blank" href="http://docs.gl/gl4/glCompressedTexImage3D">Reference Page</a>
     */
    fun compressedTexImage3D(target: TextureTarget, internalFormat: InternalFormat, size: Vec3i, imageSize: Int, data: Ptr = NULL) {
        GL13C.nglCompressedTexImage3D(target.i, 0, internalFormat.i, size.x, size.y, size.z, 0, imageSize, data)
    }
     ...
     * @see <a target="_blank" href="http://docs.gl/gl4/glCompressedTexImage3D">Reference Page</a>
     */
    fun compressedTexImage3D(level: Int, internalFormat: InternalFormat, size: Vec3i, imageSize: Int, data: Ptr = NULL) {
        GL13C.nglCompressedTexImage3D(GL12.GL_TEXTURE_3D, level, internalFormat.i, size.x, size.y, size.z, 0, imageSize, data)
    }
     ...
     * @see <a target="_blank" href="http://docs.gl/gl4/glCompressedTexImage3D">Reference Page</a>
     */
    fun compressedTexImage3D(internalFormat: InternalFormat, size: Vec3i, imageSize: Int, data: Ptr = NULL) {
        GL13C.nglCompressedTexImage3D(GL12.GL_TEXTURE_3D, 0, internalFormat.i, size.x, size.y, size.z, 0, imageSize, data)
    }
     ...
     */
    fun compressedTexImage2D(target: TextureTarget, level: Int, internalFormat: InternalFormat, size: Vec2i, imageSize: Int, data: Ptr = NULL) {
        GL13C.nglCompressedTexImage2D(target.i, level, internalFormat.i, size.x, size.y, 0, imageSize, data)
    }
     ...
     * @see <a target="_blank" href="http://docs.gl/gl4/glCompressedTexImage2D">Reference Page</a>
     */
    fun compressedTexImage2D(target: TextureTarget, internalFormat: InternalFormat, size: Vec2i, imageSize: Int, data: Ptr = NULL) {
        GL13C.nglCompressedTexImage2D(target.i, 0, internalFormat.i, size.x, size.y, 0, imageSize, data)
    }
     ...
     * @see <a target="_blank" href="http://docs.gl/gl4/glCompressedTexImage2D">Reference Page</a>
     */
    fun compressedTexImage2D(level: Int, internalFormat: InternalFormat, size: Vec2i, imageSize: Int, data: Ptr = NULL) {
        GL13C.nglCompressedTexImage2D(GL11C.GL_TEXTURE_2D, level, internalFormat.i, size.x, size.y, 0, imageSize, data)
    }
     ...
     * @see <a target="_blank" href="http://docs.gl/gl4/glCompressedTexImage2D">Reference Page</a>
     */
    fun compressedTexImage2D(internalFormat: InternalFormat, size: Vec2i, imageSize: Int, data: Ptr = NULL) {
        GL13C.nglCompressedTexImage2D(GL11C.GL_TEXTURE_2D, 0, internalFormat.i, size.x, size.y, 0, imageSize, data)
    }
     ...
     */
    fun compressedTexImage1D(level: Int, internalFormat: InternalFormat, width: Int, imageSize: Int, data: Ptr = NULL) {
        GL13C.nglCompressedTexImage1D(GL11C.GL_TEXTURE_1D, level, internalFormat.i, width, 0, imageSize, data)
    }
     ...
     * @see <a target="_blank" href="http://docs.gl/gl4/glCompressedTexImage1D">Reference Page</a>
     */
    fun compressedTexImage1D(internalFormat: InternalFormat, width: Int, imageSize: Int, data: Ptr = NULL) {
        GL13C.nglCompressedTexImage1D(GL11C.GL_TEXTURE_1D, 0, internalFormat.i, width, 0, imageSize, data)
    }
    ...
    fun compressedTexSubImage3D(target: TextureTarget, level: Int, offset: Vec3i, size: Vec3i, format: InternalFormat, imageSize: Int, data: Ptr) {
        GL13C.nglCompressedTexSubImage3D(target.i, level, offset.x, offset.y, offset.z, size.x, size.y, size.z, format.i, imageSize, data)
    }
    ...
    fun compressedTexSubImage3D(target: TextureTarget, offset: Vec3i, size: Vec3i, format: InternalFormat, imageSize: Int, data: Ptr) {
        GL13C.nglCompressedTexSubImage3D(target.i, 0, offset.x, offset.y, offset.z, size.x, size.y, size.z, format.i, imageSize, data)
    }
    ...
    fun compressedTexSubImage3D(level: Int, offset: Vec3i, size: Vec3i, format: InternalFormat, imageSize: Int, data: Ptr) {
        GL13C.nglCompressedTexSubImage3D(GL12.GL_TEXTURE_3D, level, offset.x, offset.y, offset.z, size.x, size.y, size.z, format.i, imageSize, data)
    }
    ...
    fun compressedTexSubImage3D(offset: Vec3i, size: Vec3i, format: InternalFormat, imageSize: Int, data: Ptr) {
        GL13C.nglCompressedTexSubImage3D(GL12.GL_TEXTURE_3D, 0, offset.x, offset.y, offset.z, size.x, size.y, size.z, format.i, imageSize, data)
    }
    ...
    fun compressedTexSubImage2D(target: TextureTarget, level: Int, offset: Vec2i, size: Vec2i, format: InternalFormat, imageSize: Int, data: Ptr) {
        GL13C.nglCompressedTexSubImage2D(target.i, level, offset.x, offset.y, size.x, size.y, format.i, imageSize, data)
    }
    ...
    fun compressedTexSubImage2D(target: TextureTarget, offset: Vec2i, size: Vec2i, format: InternalFormat, imageSize: Int, data: Ptr) {
        GL13C.nglCompressedTexSubImage2D(target.i, 0, offset.x, offset.y, size.x, size.y, format.i, imageSize, data)
    }
    ...
    fun compressedTexSubImage2D(level: Int, offset: Vec2i, size: Vec2i, format: InternalFormat, imageSize: Int, data: Ptr) {
        GL13C.nglCompressedTexSubImage2D(GL11C.GL_TEXTURE_2D, level, offset.x, offset.y, size.x, size.y, format.i, imageSize, data)
    }
    ...
    fun compressedTexSubImage2D(offset: Vec2i, size: Vec2i, format: InternalFormat, imageSize: Int, data: Ptr) {
        GL13C.nglCompressedTexSubImage2D(GL11C.GL_TEXTURE_2D, 0, offset.x, offset.y, size.x, size.y, format.i, imageSize, data)
    }
    ...
    fun compressedTexSubImage1D(level: Int, offset: Int, width: Int, format: InternalFormat, imageSize: Int, data: Ptr) {
        GL13C.nglCompressedTexSubImage1D(GL11C.GL_TEXTURE_1D, level, offset, width, format.i, imageSize, data)
    }
    ...
    fun compressedTexSubImage1D(offset: Int, width: Int, format: InternalFormat, imageSize: Int, data: Ptr) {
        GL13C.nglCompressedTexSubImage1D(GL11C.GL_TEXTURE_1D, 0, offset, width, format.i, imageSize, data)
    }
    ...
    fun getCompressedTexImage(target: TextureTarget, level: Int, pixels: Ptr) {
        GL13C.nglGetCompressedTexImage(target.i, level, pixels)
    }
    ...
    fun getCompressedTexImage(target: TextureTarget, pixels: Ptr) {
        GL13C.nglGetCompressedTexImage(target.i, 0, pixels)
    }
