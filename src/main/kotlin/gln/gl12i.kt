...
interface gl12i {
    ...
    var clearDepth: Double
        get() = GL11C.glGetDouble(GL20.GL_DEPTH_CLEAR_VALUE) // TODO move
     ...
     * @see <a target="_blank" href="http://docs.gl/gl4/glTexImage3D">Reference Page</a>
     */
    fun texImage3D(target: TextureTarget, level: Int, internalFormat: InternalFormat, size: Vec3i, format: ExternalFormat, type: TypeFormat, pixels: Ptr = Ptr(NULL)) {
        GL12C.nglTexImage3D(target.i, level, internalFormat.i, size.x, size.y, size.z, 0, format.i, type.i, pixels.L)
    }
     ...
     * @see <a target="_blank" href="http://docs.gl/gl4/glTexImage3D">Reference Page</a>
     */
    fun texImage3D(target: TextureTarget, internalFormat: InternalFormat, size: Vec3i, format: ExternalFormat, type: TypeFormat, pixels: Ptr = Ptr(NULL)) {
        GL12C.nglTexImage3D(target.i, 0, internalFormat.i, size.x, size.y, size.z, 0, format.i, type.i, pixels.L)
    }
     ...
     * @see <a target="_blank" href="http://docs.gl/gl4/glTexImage3D">Reference Page</a>
     */
    fun texImage3D(level: Int, internalFormat: InternalFormat, size: Vec3i, format: ExternalFormat, type: TypeFormat, pixels: Ptr = Ptr(NULL)) {
        GL12C.nglTexImage3D(GL12.GL_TEXTURE_3D, level, internalFormat.i, size.x, size.y, size.z, 0, format.i, type.i, pixels.L)
    }
     ...
     * @see <a target="_blank" href="http://docs.gl/gl4/glTexImage3D">Reference Page</a>
     */
    fun texImage3D(internalFormat: InternalFormat, size: Vec3i, format: ExternalFormat, type: TypeFormat, pixels: Ptr = Ptr(NULL)) {
        GL12C.nglTexImage3D(GL12.GL_TEXTURE_3D, 0, internalFormat.i, size.x, size.y, size.z, 0, format.i, type.i, pixels.L)
    }
    ...
    fun texSubImage3D(target: TextureTarget, level: Int, offset: Vec3i, size: Vec3i, format: ExternalFormat, type: TypeFormat, pixels: Ptr) {
        GL12C.nglTexSubImage3D(target.i, level, offset.x, offset.y, offset.z, size.x, size.y, size.z, format.i, type.i, pixels.L)
    }
    ...
    fun texSubImage3D(target: TextureTarget, offset: Vec3i, size: Vec3i, format: ExternalFormat, type: TypeFormat, pixels: Ptr) {
        GL12C.nglTexSubImage3D(target.i, 0, offset.x, offset.y, offset.z, size.x, size.y, size.z, format.i, type.i, pixels.L)
    }
    ...
    fun texSubImage3D(level: Int, offset: Vec3i, size: Vec3i, format: ExternalFormat, type: TypeFormat, pixels: Ptr) {
        GL12C.nglTexSubImage3D(GL12.GL_TEXTURE_3D, level, offset.x, offset.y, offset.z, size.x, size.y, size.z, format.i, type.i, pixels.L)
    }
    ...
    fun texSubImage3D(offset: Vec3i, size: Vec3i, format: ExternalFormat, type: TypeFormat, pixels: Ptr) {
        GL12C.nglTexSubImage3D(GL12.GL_TEXTURE_3D, 0, offset.x, offset.y, offset.z, size.x, size.y, size.z, format.i, type.i, pixels.L)
    }
    ...
    fun drawRangeElements(mode: DrawMode, start: Int, end: Int, count: Int, type: DataType, indices: Ptr = Ptr(NULL)) {
        GL12C.nglDrawRangeElements(mode.i, start, end, count, type.i, indices.L)
    }
    ...
    fun drawRangeElements(start: Int, end: Int, count: Int, type: DataType, indices: Ptr = Ptr(NULL)) {
        GL12C.nglDrawRangeElements(GL11C.GL_TRIANGLES, start, end, count, type.i, indices.L)
    }
