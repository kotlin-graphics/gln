...
interface gl11i {
    ...
    var colorMask: Vec4bool
        get() = vec4bool(GL11C.GL_COLOR_WRITEMASK)
     ...
     * @see <a target="_blank" href="http://docs.gl/gl4/glGetTexImage">Reference Page</a>
     */
    fun getTexImage(tex: TextureTarget, level: Int, format: ExternalFormat, type: TypeFormat, pixels: Ptr) = GL11C.nglGetTexImage(tex.i, level, format.i, type.i, pixels.L)
    ...
    fun readPixels(pos: Vec2i, size: Vec2i, format: ExternalFormat, type: TypeFormat, pixels: Ptr) {
        GL11C.nglReadPixels(pos.x, pos.y, size.x, size.y, format.i, type.i, pixels.L)
    }
    ...
    var scissorBox: Vec4i
        get() = vec4i(GL11C.GL_SCISSOR_BOX)
     ...
     * @see <a target="_blank" href="http://docs.gl/gl4/glTexImage1D">Reference Page</a>
     */
    fun texImage1D(level: Int, internalFormat: InternalFormat, width: Int, format: ExternalFormat, type: TypeFormat, pixels: Ptr = Ptr(NULL)) {
        GL11C.nglTexImage1D(GL11C.GL_TEXTURE_1D, level, internalFormat.i, width, 0, format.i, type.i, pixels.L)
    }
     ...
     * @see <a target="_blank" href="http://docs.gl/gl4/glTexImage1D">Reference Page</a>
     */
    fun texImage1D(internalFormat: InternalFormat, width: Int, format: ExternalFormat, type: TypeFormat, pixels: Ptr = Ptr(NULL)) {
        GL11C.nglTexImage1D(GL11C.GL_TEXTURE_1D, 0, internalFormat.i, width, 0, format.i, type.i, pixels.L)
    }
     ...
     * @see <a target="_blank" href="http://docs.gl/gl4/glTexImage2D">Reference Page</a>
     */
    fun texImage2D(target: TextureTarget, level: Int, internalFormat: InternalFormat, size: Vec2i, format: ExternalFormat, type: TypeFormat, pixels: Ptr = Ptr(NULL)) {
        GL11C.nglTexImage2D(target.i, level, internalFormat.i, size.x, size.y, 0, format.i, type.i, pixels.L)
    }
     ...
     * @see <a target="_blank" href="http://docs.gl/gl4/glTexImage2D">Reference Page</a>
     */
    fun texImage2D(target: TextureTarget, internalFormat: InternalFormat, size: Vec2i, format: ExternalFormat, type: TypeFormat, pixels: Ptr = Ptr(NULL)) {
        GL11C.nglTexImage2D(target.i, 0, internalFormat.i, size.x, size.y, 0, format.i, type.i, pixels.L)
    }
     ...
     * @see <a target="_blank" href="http://docs.gl/gl4/glTexImage2D">Reference Page</a>
     */
    fun texImage2D(level: Int, internalFormat: InternalFormat, size: Vec2i, format: ExternalFormat, type: TypeFormat, pixels: Ptr = Ptr(NULL)) {
        GL11C.nglTexImage2D(GL11C.GL_TEXTURE_2D, level, internalFormat.i, size.x, size.y, 0, format.i, type.i, pixels.L)
    }
     ...
     * @see <a target="_blank" href="http://docs.gl/gl4/glTexImage2D">Reference Page</a>
     */
    fun texImage2D(internalFormat: InternalFormat, size: Vec2i, format: ExternalFormat, type: TypeFormat, pixels: Ptr = Ptr(NULL)) {
        GL11C.nglTexImage2D(GL11C.GL_TEXTURE_2D, 0, internalFormat.i, size.x, size.y, 0, format.i, type.i, pixels.L)
    }
    ...
    fun texSubImage1D(level: Int, xOffset: Int, width: Int, format: ExternalFormat, type: TypeFormat, pixels: Ptr) {
        GL11C.nglTexSubImage1D(GL11C.GL_TEXTURE_1D, level, xOffset, width, format.i, type.i, pixels.L)
    }
    ...
    fun texSubImage1D(xOffset: Int, width: Int, format: ExternalFormat, type: TypeFormat, pixels: Ptr) {
        GL11C.nglTexSubImage1D(GL11C.GL_TEXTURE_1D, 0, xOffset, width, format.i, type.i, pixels.L)
    }
    ...
    fun texSubImage2D(target: TextureTarget, level: Int, offset: Vec2i, size: Vec2i, format: ExternalFormat, type: TypeFormat, pixels: Ptr) {
        GL11C.nglTexSubImage2D(target.i, level, offset.x, offset.y, size.x, size.y, format.i, type.i, pixels.L)
    }
    ...
    fun texSubImage2D(target: TextureTarget, offset: Vec2i, size: Vec2i, format: ExternalFormat, type: TypeFormat, pixels: Ptr) {
        GL11C.nglTexSubImage2D(target.i, 0, offset.x, offset.y, size.x, size.y, format.i, type.i, pixels.L)
    }
    ...
    fun texSubImage2D(level: Int, offset: Vec2i, size: Vec2i, format: ExternalFormat, type: TypeFormat, pixels: Ptr) {
        GL11C.nglTexSubImage2D(GL11C.GL_TEXTURE_2D, level, offset.x, offset.y, size.x, size.y, format.i, type.i, pixels.L)
    }
    ...
    fun texSubImage2D(offset: Vec2i, size: Vec2i, format: ExternalFormat, type: TypeFormat, pixels: Ptr) {
        GL11C.nglTexSubImage2D(GL11C.GL_TEXTURE_2D, 0, offset.x, offset.y, size.x, size.y, format.i, type.i, pixels.L)
    }
