...
inline fun glVertexAttribPointer(layout: VertexLayout) {
    layout.attributes.forEach(::glVertexAttribPointer)
}
inline fun glEnableVertexAttribArray(layout: VertexLayout) {
    layout.attributes.forEach(::glEnableVertexAttribArray)
}
inline fun glDisableVertexAttribArray(layout: VertexLayout) {
    layout.attributes.forEach(::glDisableVertexAttribArray)
}
