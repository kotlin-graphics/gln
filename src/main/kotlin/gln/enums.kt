...
val CURRENT_BIT = AttribMask(GL11.GL_CURRENT_BIT)
val POINT_BIT = AttribMask(GL11.GL_POINT_BIT)
val LINE_BIT = AttribMask(GL11.GL_LINE_BIT)
val POLYGON_BIT = AttribMask(GL11.GL_POLYGON_BIT)
val POLYGON_STIPPLE_BIT = AttribMask(GL11.GL_POLYGON_STIPPLE_BIT)
val PIXEL_MODE_BIT = AttribMask(GL11.GL_PIXEL_MODE_BIT)
val LIGHTING_BIT = AttribMask(GL11.GL_LIGHTING_BIT)
val FOG_BIT = AttribMask(GL11.GL_FOG_BIT)
val DEPTH_BUFFER_BIT_ = AttribMask(GL11.GL_DEPTH_BUFFER_BIT)
val ACCUM_BUFFER_BIT_ = AttribMask(GL11.GL_ACCUM_BUFFER_BIT)
val STENCIL_BUFFER_BIT_ = AttribMask(GL11.GL_STENCIL_BUFFER_BIT)
val VIEWPORT_BIT = AttribMask(GL11.GL_VIEWPORT_BIT)
val TRANSFORM_BIT = AttribMask(GL11.GL_TRANSFORM_BIT)
val ENABLE_BIT = AttribMask(GL11.GL_ENABLE_BIT)
val COLOR_BUFFER_BIT_ = AttribMask(GL11.GL_COLOR_BUFFER_BIT)
val HINT_BIT = AttribMask(GL11.GL_HINT_BIT)
val EVAL_BIT = AttribMask(GL11.GL_EVAL_BIT)
val LIST_BIT = AttribMask(GL11.GL_LIST_BIT)
val TEXTURE_BIT = AttribMask(GL11.GL_TEXTURE_BIT)
val SCISSOR_BIT = AttribMask(GL11.GL_SCISSOR_BIT)
val ALL_ATTRIB_BITS = AttribMask(GL11.GL_ALL_ATTRIB_BITS)
// VERSION_1_3 enum: (Promoted for OpenGL 1.3)
val MULTISAMPLE_BIT = AttribMask(GL13.GL_MULTISAMPLE_BIT)
...
val ACCUM_BUFFER_BIT = ClearBufferMask(GL11.GL_ACCUM_BUFFER_BIT)
