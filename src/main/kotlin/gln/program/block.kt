...
object ProgramUse {
    ...
    infix fun Vec2.to(location: Int) = GL20.nglUniform2fv(location, 1, toOffHeap())

    infix fun Vec3.to(location: Int) = GL20.nglUniform3fv(location, 1, toOffHeap())

    infix fun Vec4.to(location: Int) = GL20.nglUniform4fv(location, 1, toOffHeap())

    infix fun Mat2.to(location: Int) = GL20.nglUniformMatrix2fv(location, 1, false, toOffHeap())

    infix fun Mat3.to(location: Int) = GL20.nglUniformMatrix3fv(location, 1, false, toOffHeap())

    infix fun Mat4.to(location: Int) = GL20.nglUniformMatrix4fv(location, 1, false, toOffHeap())

    infix fun Int.to(uniform: String) = to(uniform.uniform)
    infix fun Float.to(uniform: String) = to(uniform.uniform)

    infix fun Vec2.to(uniform: String) = to(uniform.uniform)

    infix fun Vec3.to(uniform: String) = to(uniform.uniform)

    infix fun Vec4.to(uniform: String) = to(uniform.uniform)

    infix fun Mat2.to(uniform: String) = to(uniform.uniform)

    infix fun Mat3.to(uniform: String) = to(uniform.uniform)

    infix fun Mat4.to(uniform: String) = to(uniform.uniform)
}
